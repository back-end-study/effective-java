...
<table class="waffle" cellspacing="0" cellpadding="0">
    ...
    <tr style="height: 20px">
        ...
        <td class="s3" dir="ltr">소정</td>
        <td class="s3" dir="ltr">윤희</td>
    </tr>
    <tr style="height: 20px">
        ...
        <td class="s3" dir="ltr">영진</td>
        <td class="s3" dir="ltr">세용</td>
    </tr>
    <tr style="height: 20px">
        ...
        <td class="s3" dir="ltr">영준</td>
        <td class="s3" dir="ltr">사욱</td>
    </tr>
    <tr style="height: 20px">
